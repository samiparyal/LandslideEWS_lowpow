...
//2.4 GHz - ble operation // A single "Time Slot" is defined as 625 microsec - 0.625 ms.
#define ADV_INTERVAL_MIN                    (0x0080) // Fast: 128 decimal * 0.625ms = 80ms
#define ADV_INTERVAL_MAX                    (0x00A0) // Fast: 160 decimal * 0.625ms = 100ms
#define ADV_LP_INTERVAL_MIN    (0x0C80)  // 3200 * 0.625ms = 2000ms
...
#define ADV_FILTER                          HCI_ADV_FILTER_ACCEPT_LIST_CONNECT   //HCI_ADV_FILTER_NONE //HCI_ADV_FILTER_ACCEPT_LIST_CONNECT //uncomment on production
...
typedef enum
{
  ...
  CFG_TASK_ALARM_TIMEOUT_ID,
  CFG_TASK_TILT_POLL_ID,
  CFG_TASK_RAW_IMU_SEND_ID,
