...
/**
  ...
  *
  */
int32_t lsm6dsv16x_ois_reset_set(const stmdev_ctx_t *ctx, int8_t val) //ois - optical image stabilization
{
  lsm6dsv16x_func_cfg_access_t func_cfg_access;
  int32_t ret;
...
/**
  ...
  *
  */
int32_t lsm6dsv16x_sh_reset_set(const stmdev_ctx_t *ctx, uint8_t val) // sh - sensor hub block
{
  lsm6dsv16x_master_config_t master_config;
  int32_t ret;
